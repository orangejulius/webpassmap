...
class BuildingsControllerTest < ActionController::TestCase
  ...
  test "should create building" do
    assert_difference('Building.count') do
      post :create, building: { businessService: @building.businessService, name: @building.name, speeds: @building.speeds }
    end
  ...
  test "should update building" do
    put :update, id: @building, building: { businessService: @building.businessService, name: @building.name, speeds: @building.speeds }
    assert_redirected_to building_path(assigns(:building))
  end
